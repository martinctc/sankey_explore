alluvial_x <- function (..., freq, col = "gray", border = 0, layer, hide = FALSE, 
                      ...
                      ordering = NULL, axis_labels = NULL, cex = par("cex"), cex.axis = par("cex.axis")) 
{
  ...
  plot(NULL, type = "n", xlim = c(1 - cw, np + cw), ylim = c(0, 1),
                      xaxt = "n", yaxt = "n", xaxs = "i", yaxs = "i", xlab = "", 
                      ylab = "", frame = FALSE)
